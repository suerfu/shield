...
DetectorConstruction::DetectorConstruction() : G4VUserDetectorConstruction() {
    ...
    list.push_back( ShieldInfo("Pb",    "G4_POLYETHYLENE",      122*cm, 1   ) );
    list.push_back( ShieldInfo("Pb",    "G4_Pb",                102*cm, 2, 10 ) );
    list.push_back( ShieldInfo("PE",    "G4_POLYETHYLENE",      62*cm,  1   ) );
